...
class MoreGame(
    ...
    constructor(parcel: Parcel) : this(
        ...
        parcel.readString()!!,
        parcel.readString()!!,
        listOf<String>(parcel.readString()!!),
        TODO("comment")
    )
    ...
    companion object CREATOR : Parcelable.Creator<MoreGame> {
        override fun createFromParcel(parcel: Parcel): MoreGame {
            return MoreGame(parcel)
        }

        override fun newArray(size: Int): Array<MoreGame?> {
