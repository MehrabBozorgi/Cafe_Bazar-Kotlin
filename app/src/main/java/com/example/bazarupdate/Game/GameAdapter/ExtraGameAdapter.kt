...
class ExtraGameAdapter(var list: List<MoreGame>, var onClickExtraGame: (id: MoreGame) -> Unit) :
    RecyclerView.Adapter<ExtraGameAdapter.ExtraGameViewHolder>() {

    class ExtraGameViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ExtraGameViewHolder {
        var view =
            LayoutInflater.from(parent.context).inflate(R.layout.more_game_row, parent, false)
        return ExtraGameViewHolder(view)

    }

    override fun onBindViewHolder(holder: ExtraGameViewHolder, position: Int) {
